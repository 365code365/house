...
-- AddForeignKey
ALTER TABLE `sales_control` ADD CONSTRAINT `sales_control_project_id_fkey` FOREIGN KEY (`project_id`) REFERENCES `project`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `sales_control` ADD CONSTRAINT `sales_control_sales_id_fkey` FOREIGN KEY (`sales_id`) REFERENCES `sales_personnel`(`employee_no`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `parking_space` ADD CONSTRAINT `parking_space_project_id_fkey` FOREIGN KEY (`project_id`) REFERENCES `project`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `customer_appointment` ADD CONSTRAINT `customer_appointment_project_id_fkey` FOREIGN KEY (`project_id`) REFERENCES `project`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `customer_appointment` ADD CONSTRAINT `customer_appointment_sales_id_fkey` FOREIGN KEY (`sales_id`) REFERENCES `sales_personnel`(`employee_no`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `purchased_customer` ADD CONSTRAINT `purchased_customer_project_id_fkey` FOREIGN KEY (`project_id`) REFERENCES `project`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `purchased_customer` ADD CONSTRAINT `purchased_customer_sales_id_fkey` FOREIGN KEY (`sales_id`) REFERENCES `sales_personnel`(`employee_no`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `visitor_questionnaire` ADD CONSTRAINT `visitor_questionnaire_project_id_fkey` FOREIGN KEY (`project_id`) REFERENCES `project`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `withdrawal_record` ADD CONSTRAINT `withdrawal_record_project_id_fkey` FOREIGN KEY (`project_id`) REFERENCES `project`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `budget_plan` ADD CONSTRAINT `budget_plan_project_id_fkey` FOREIGN KEY (`project_id`) REFERENCES `project`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `expense_management` ADD CONSTRAINT `expense_management_project_id_fkey` FOREIGN KEY (`project_id`) REFERENCES `project`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `commission_list` ADD CONSTRAINT `commission_list_project_id_fkey` FOREIGN KEY (`project_id`) REFERENCES `project`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `commission_list` ADD CONSTRAINT `commission_list_sales_id_fkey` FOREIGN KEY (`sales_id`) REFERENCES `sales_personnel`(`employee_no`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `commission_details` ADD CONSTRAINT `commission_details_commission_id_fkey` FOREIGN KEY (`commission_id`) REFERENCES `commission_list`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `deposit_management` ADD CONSTRAINT `deposit_management_project_id_fkey` FOREIGN KEY (`project_id`) REFERENCES `project`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `handover_management` ADD CONSTRAINT `handover_management_project_id_fkey` FOREIGN KEY (`project_id`) REFERENCES `project`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
